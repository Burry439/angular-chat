...
var AppComponent = /** @class */ (function () {
    function AppComponent(pusherService) {
        this.pusherService = pusherService;
        this.title = 'Pusher Liker';
        this.likes = 10;
        this.messeges = [];
        this.chat = {
            name: null,
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.pusherService.channel.bind('new-msg', function (data) {
            ...
            console.log(_this.messeges);
        });
    };
    // add to the number of likes to the server
    AppComponent.prototype.liked = function () {
        this.pusherService.like(this.likes);
    };
    AppComponent.prototype.addMsg = function () {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_pusher_service__WEBPACK_IMPORTED_MODULE_2__["PusherService"]],
